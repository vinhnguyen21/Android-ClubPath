...
class Lifting3DModel(context: Context) : Closeable {
    ...
    private fun init3DInput(keypoint: INDArray): ByteBuffer {
        ...
        // Convert the float buffer to a ByteBuffer
        val byteBuffer: ByteBuffer =
            ByteBuffer.allocate(floatBuffer.size * 4) // Assuming each float occupies 4 bytes
        ...
        // Reset the position of the ByteBuffer to read from the beginning
        byteBuffer.flip()
